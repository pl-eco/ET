...
public class ECMClassDecl_c extends JL5ClassDecl_c {
	...
	public Node buildTypes(TypeBuilder tb) throws SemanticException {
		...
		this.modeFieldName = eFlags.getModeWithoutPrefix();
	...
	// each class implements $Modeable class
	...
	public void prettyPrint(CodeWriter w, PrettyPrinter tr) {
		...
		// print the static block for library class loading. It is needed in
		// order to enable the CPU scaling
		if (cs.data.Properties.entryClass.equals(this.type().fullName()))
			w.write("static { System.loadLibrary(\"scalelib\"); }");
		...
		// + Names.MPTN_CLASS_NAME;
		//
		// sb.setLength(0);
		// // class decl
		// sb.append("class ").append(mptnName)/*
		// * .append(" extends ")
