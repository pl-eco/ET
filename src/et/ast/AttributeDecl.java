...
public class AttributeDecl extends JL5MethodDecl_c {
	public AttributeDecl(Position pos, TypeNode returnType, Id name) {
	 ...
	 * return type as the class, instead of modev
	 */
	public void prettyPrintHeader(Flags flags, CodeWriter w, PrettyPrinter tr) {
		...
		// modification
		w.write(this.mi.container().toString());
